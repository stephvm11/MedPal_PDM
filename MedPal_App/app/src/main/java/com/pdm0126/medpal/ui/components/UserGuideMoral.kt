    ...
    AnimatedVisibility(
        ...
        Box(
            ...
            Column(
                ...
                Text(
                    text = "¡Bienvenido a MedPal!\nTu compañero inteligente para el cuidado de tu salud. Esta aplicación ha sido diseñada con el objetivo de ayudarte a organizar, gestionar y recordar de manera exacta todas tus tomas de medicamentos y citas médicas pendientes.",
                    fontSize = 15.sp,
